...
(function ($) {
  ...
  $.Scalebar.prototype = {
    ...
    refresh: function (options) {
      ...
      var currentPPM = zoom * this.pixelsPerMeter * SCALEBAR_VIZ_SCALE;
    ...
    drawMicroscopyScalebar: function (size, text) {
      ...
      this.divElt.style.textAlign = 'left';
      ...
      this.divElt.style.width = size / SCALEBAR_VIZ_SCALE + 'px';
    },
    /**
    ...
    //   canvas.width = this.divElt.offsetWidth / 200;
    //   console.log('As canvas!');
    //   canvas.width = 1;
    //   canvas.height = 1;
    //   canvas.height = this.divElt.offsetHeight / 200;
    ...
    //   newCanvas.width = imgCanvas.width / 20;
